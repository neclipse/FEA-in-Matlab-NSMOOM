...
elseif nargin==3
    ...
    obj.plotcontour('UX',nodestructure);
    obj.plotcontour('UY',nodestructure);
    obj.plotcontour('EPBar',pointstructure);
    obj.plotcontour('SG',pointstructure,1);
    obj.plotcontour('SG',pointstructure,2);
elseif nargin==4
    nodestructure=varargin{1}; 
    pointstructure=varargin{2};
    ...
    obj.plotcontour('SG',pointstructure,1,nocontour);
    obj.plotcontour('SG',pointstructure,2,nocontour);
