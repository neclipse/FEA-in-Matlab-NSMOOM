...
% curloads1=[sgmh+ppi,sgmv+ppi,0,sgmH+ppi];
curloads={[pwb,0]};                      % Normal traciton is wellbore pressure, shear traction is zero.
...
psi=20*pi/180;                            % shear dilatant angle
...
%% -- Domain
predisp=[0;0;0;0];                          % Model is constrained by prescribed displaceemnt
% Set the domain with plane strain, DP material, precribed displacements to boundaries
Wb=Domain(2,2,predisp); 
%% --Preprocessor
...
%               0 0 0  25  0 ];
BCTable_node=[];
preprocessor=Preprocessor(4,{fb1;fb2;fb3;fb4},[1,1,0;0,0,3;0,1,0;1,0,0],BCTable_node,curloads);
...
iniincrem=0.40;                                % initial increment size
